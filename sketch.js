...
// BFS from player to compute the set of reachable cells, optionally treating (excludeX,excludeY) as blocked
function getReachableFromPlayer(excludeX = null, excludeY = null) {
  ...
  return seen; // set of "x,y" strings reachable from player (without stepping on excluded cell)
}
...
function setup() {
  ...
  // Stop looping- make redrawing manual
  noLoop();
}
